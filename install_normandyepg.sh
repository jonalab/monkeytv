...
if
[ "`cat /app/NormandyEPG/Normandy_EPG.ver 2>/dev/null`" != "`curl -s http://normandy.es/teuve/Normandy_EPG.ver 2>/dev/null`" ];
then
echo "entro"
#
...
wget -P /tmp/ normandy.es/teuve/Normandy_EPG.zip
